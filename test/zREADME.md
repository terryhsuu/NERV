...
- (**10 %**) Protect main branch 
    - Merge only when all team member(not including TAs) approves.
    - Main branch should be clean. No redundancy code and bug.
...
- (**10 %**) Pass the baseline
    - We will test your agent against RandomAgent. You need to have an at least 80% win rate to get 10 points.
